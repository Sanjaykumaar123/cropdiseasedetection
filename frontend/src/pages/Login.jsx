    ...
    return (
        <div className="container flex-center" style={{ minHeight: '80vh' }}>
            <div className="glass-card animate-fade-in" style={{ width: '100%', maxWidth: '400px', padding: '40px' }}>
                <h2 style={{ textAlign: 'center', marginBottom: '30px', color: '#2F855A' }}>Welcome Back</h2>
                ...
                <p style={{ marginTop: '20px', textAlign: 'center', fontSize: '0.9rem', color: '#718096' }}>
                    Don't have an account? <Link to="/register" style={{ color: '#2F855A', fontWeight: '600' }}>Register here</Link>
                </p>
            </div>
        </div>
    );
